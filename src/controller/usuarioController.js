...
import getPerfil, { atualizarFotoDePerfil, inserirUsuario, showAllUsuarios, verificarUsuario } from "../repository/usuarioRepository.js";
...
endPoints.get('/usuario/show-all-usuarios', autenticar, async (req, resp) => {
    try {
        const usuarioId = req.usuario.id;

        const usuarios = await showAllUsuarios(usuarioId);

        resp.send({ listaUsuarios: usuarios });
